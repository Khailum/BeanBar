...
namespace BeanBarAPI.Services
{
    public class AuthService : IAuthService
    {
        ...
        private readonly IIDNumberValidator _idValidator;

        public AuthService(CoffeeDBContext context, IPasswordService passwordService, IIDNumberValidator idValidator)
        {
            _context = context;
