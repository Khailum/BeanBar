...
namespace BeanBar_Back_end.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateOrderForCustomer(string customerId, [FromBody] OrderCreateDto dto)
        {
            var customerExists = await _context.Users.AnyAsync(u => u.CustomerID == customerId);
            if (!customerExists)
            ...
            var order = new Order
            {
                ...
                OrderNum = new Random().Next(100, 99999),
                ItemID = dto.MenuID,
                Address = dto.Address,
